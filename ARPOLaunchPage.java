...
/** ARPOLaunchPage is a new class that displayes a new window for a specific movie. 
* @authors Dursen Tulema, Hegni Yonis, Nolan Thomson*/


public class ARPOLaunchPage extends Frame implements ActionListener
{
/** Construct a new ARPOLaunchPage. */
  ...
  public void paint(Graphics g)
        { 
         ...
         Image img1 = tk.getImage("ARPOwindow.png");
   ...
   public void actionPerformed(ActionEvent ae)
	  {
		...
		{
      rARPOLaunchPage reciept = new rARPOLaunchPage();
		System.out.println("You Are Renting 'Ready Player One' Movie...");
      System.out.println("   ");
      ...
      System.out.println("   ");
                        ...
                        System.out.println("|------------------------------------------------|");
                        System.out.println("|    Rented Movie: Ready Player One              |");
                        System.out.println("|    Amount Paid: $16.57                         |");
                        System.out.println("|------------------------------------------------|");
                        System.out.println("|    Release Year: 2018                          |");
                        System.out.println("|------------------------------------------------|");
                        System.out.println("|    Movie Lenght: 2:20                          |");
                        System.out.println("|    Movie Rating: 72%                           |"); 
                        System.out.println("|________________________________________________|");
                        
      System.out.println("   ");
      System.out.println("You have Successfully rented 'Ready Player One' Movie.");
      System.out.println("   ");

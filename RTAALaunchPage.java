...
/** RTAALaunchPage is a new class that displayes a new window for a specific movie. 
  * @authors Dursen Tulema, Hegni Yonis, Nolan Thomson*/

public class RTAALaunchPage extends Frame implements ActionListener
{     
/** Construct a new RTAALaunchPage. */
      ...
      Button btnRent;
      public RTAALaunchPage()
      
      {
         
         super("The Age of Adeline"); 
         resize(1200,675);
         show();
			makeMenus();
  ...
  public void paint(Graphics g)
        { 
         ...
         Image img1 = tk.getImage("Age_of_Adeline.png");
   ...
   public void actionPerformed(ActionEvent ae)
	  {
		...
		{
     rRTAALaunchPage DHNAction = new rRTAALaunchPage();
		System.out.println("You Are Renting 'The Age of Adeline' Movie...");
      ...
      System.out.println("   ");
                        ...
                        System.out.println("|------------------------------------------------|");
                        System.out.println("|    Rented Movie: The Age of Adeline            |");
                        System.out.println("|    Amount Paid: $14.99                         |");
                        System.out.println("|------------------------------------------------|");
                        System.out.println("|    Release Year: 2015                          |");
                        System.out.println("|------------------------------------------------|");
                        System.out.println("|    Movie Lenght: 1:52                          |");
                        System.out.println("|    Movie Rating: 55%                           |"); 
                        System.out.println("|________________________________________________|");
                        
      System.out.println("   ");
      System.out.println("You have Successfully rented 'The Age of Adeline' Movie.");
      System.out.println("   ");

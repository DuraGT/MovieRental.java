...
/** RTAILaunchPage is a new class that displayes a new window for a specific movie. 
  * @authors Dursen Tulema, Hegni Yonis, Nolan Thomson*/


public class RTAILaunchPage extends Frame implements ActionListener
{

/** Construct a new RTAILaunchPage. */
      ...
      Button btnRent;
      public RTAILaunchPage()
      
      {
         
         super("The Age of Innocence"); 
         resize(1200,675);
         show();
			makeMenus();
  ...
  public void paint(Graphics g)
        { 
         ...
         Image img1 = tk.getImage("Age_of_Innocence.png");
    ...
    public void actionPerformed(ActionEvent ae)
	  {
		...
		{ 
      rRTAILaunchPage receipt = new rRTAILaunchPage();
		System.out.println("You Are Renting 'The Age of Innocence...");
      System.out.println("   ");
      ...
      System.out.println("   ");
                        ...
                        System.out.println("|------------------------------------------------|");
                        System.out.println("|    Rented Movie: The Age of Innocence          |");
                        System.out.println("|    Amount Paid: $14.99                         |");
                        System.out.println("|------------------------------------------------|");
                        System.out.println("|    Release Year: 1993                          |");
                        System.out.println("|------------------------------------------------|");
      ...
      System.out.println("   ");
		System.out.println("You Are Renting 'The Age of Innocence' Movie...");
      System.out.println("   ");  
	   }

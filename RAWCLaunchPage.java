...
/** RAWCLaunchPage is a new class that displayes a new window for a specific movie. 
  * @authors Dursen Tulema, Hegni Yonis, Nolan Thomson*/

public class RAWCLaunchPage extends Frame implements ActionListener
{

   /** Construct a new RAWCLaunchPage. */
      ...
      Button btnRent;
      public RAWCLaunchPage()
      
      {
         
         super("After We Collided"); 
         resize(1200,675);
         show();
			makeMenus();
  ...
  public void paint(Graphics g)
        { 
         ...
         Image img1 = tk.getImage("After_We_Collided.png");
   ...
   public void actionPerformed(ActionEvent ae)
	  {
		...
		{
		rRAWCLaunchPage RECIERPT = new rRAWCLaunchPage();
		System.out.println("You Are Renting 'After We Collided' Movie...");
      ...
      System.out.println("   ");
                        ...
                        System.out.println("|------------------------------------------------|");
                        System.out.println("|    Rented Movie: After We Collided             |");
                        System.out.println("|    Amount Paid: $57.00                         |");
                        System.out.println("|------------------------------------------------|");
                        System.out.println("|    Release Year: 2020                          |");
                        System.out.println("|------------------------------------------------|");
                        System.out.println("|    Movie Lenght: 1:45                          |");
                        System.out.println("|    Movie Rating: 13%                           |"); 
                        System.out.println("|________________________________________________|");
                        
      System.out.println("   ");
      System.out.println("You have Successfully rented 'After We Collided' Movie.");
      System.out.println("   ");

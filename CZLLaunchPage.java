...
/** CZLLaunchPage is a new class that displayes a new window for a specific movie. 
  * @authors Dursen Tulema, Hegni Yonis, Nolan Thomson*/


public class CZLLaunchPage extends Frame implements ActionListener
{
   /** Construct a new CZLLaunchPage. */
  ...
  public void paint(Graphics g)
        { 
         ...
         Image img1 = tk.getImage("CZLwindow.png");
   ...
   public void actionPerformed(ActionEvent ae)
	  {
		...
		{
		System.out.println("You Are Renting 'Zombieland' Movie...");
      ...
      System.out.println("   ");
                        ...
                        System.out.println("|------------------------------------------------|");
                        System.out.println("|    Rented Movie: Zombieland                    |");
                        System.out.println("|    Amount Paid: $14.99                         |");
                        System.out.println("|------------------------------------------------|");
                        System.out.println("|    Release Year: 2009                          |");
                        System.out.println("|------------------------------------------------|");
                        System.out.println("|    Movie Lenght: 1:28                          |");
                        System.out.println("|    Movie Rating: 89%                           |"); 
                        System.out.println("|________________________________________________|");
                        
      System.out.println("   ");
      System.out.println("You have Successfully rented 'Zombieland' Movie.");
      System.out.println("   ");

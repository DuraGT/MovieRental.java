...
/** RTTCLaunchPage is a new class that displayes a new window for a specific movie. 
  * @authors Dursen Tulema, Hegni Yonis, Nolan Thomson*/

public class RTTCLaunchPage extends Frame implements ActionListener
{
/** Construct a new RTTCLaunchPage. */
  ...
  public void paint(Graphics g)
        { 
         ...
         Image img1 = tk.getImage("titanicbackground.png");
   ...
   public void actionPerformed(ActionEvent ae)
	  {
		...
		{
      rRTTCLaunchPage reciept = new rRTTCLaunchPage();
      System.out.println("You Are Renting 'Titanic' Movie...");
      ...
      System.out.println("   ");
                        ...
                        System.out.println("|------------------------------------------------|");
                        System.out.println("|    Rented Movie: Titanic                       |");
                        System.out.println("|    Amount Paid: $24.99                         |");
                        System.out.println("|------------------------------------------------|");
                        System.out.println("|    Release Year: 1997                          |");
                        System.out.println("|------------------------------------------------|");
                        System.out.println("|    Movie Lenght: 3:14                          |");
                        System.out.println("|    Movie Rating: 87%                           |"); 
                        System.out.println("|________________________________________________|");
                        
      System.out.println("   ");
      System.out.println("You have Successfully rented 'Titanic.");
      System.out.println("   ");

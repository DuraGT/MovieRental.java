...
/** AWWLaunchPage is a new class that displayes a new window for a specific movie. 
  * @authors Dursen Tulema, Hegni Yonis, Nolan Thomson*/

public class AWWLaunchPage extends Frame implements ActionListener
{
  /** Construct a new AWWLaunchPage. */
  ...
  public void paint(Graphics g)
        { 
         ...
         Image img1 = tk.getImage("AWWwindow.png");
   ...
   public void actionPerformed(ActionEvent ae)
	  {
		...
		{
      rAWWLaunchPage reciept = new rAWWLaunchPage();
		System.out.println("You Are Renting 'Wonder Woman' Movie...");
       System.out.println("   ");
      ...
      System.out.println("   ");
                        ...
                        System.out.println("|------------------------------------------------|");
                        System.out.println("|    Rented Movie: Wonder Woman                  |");
                        System.out.println("|    Amount Paid: $16.57                         |");
                        System.out.println("|------------------------------------------------|");
                        System.out.println("|    Release Year: 2017                          |");
                        System.out.println("|------------------------------------------------|");
                        System.out.println("|    Movie Lenght: 2:21                          |");
                        System.out.println("|    Movie Rating: 93%                           |"); 
                        System.out.println("|________________________________________________|");
                        
      System.out.println("   ");
      System.out.println("You have Successfully rented 'Wonder Woman' Movie.");
      System.out.println("   ");

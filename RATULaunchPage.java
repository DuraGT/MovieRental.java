...
/** RATULaunchPage is a new class that displayes a new window for a specific movie. 
  * @authors Dursen Tulema, Hegni Yonis, Nolan Thomson*/


public class RATULaunchPage extends Frame implements ActionListener
{
  /** Construct a new RATULaunchPage. */
      ...
      Button btnRent;
      public RATULaunchPage()
      
      {
         
         super("Across the Universe"); 
         resize(1200,675);
         show();
			makeMenus();
  ...
  public void paint(Graphics g)
        { 
         ...
         Image img1 = tk.getImage("Across_the_Universe.png");
   ...
   public void actionPerformed(ActionEvent ae)
	  {
		...
		{
		rRATULaunchPage reciept = new rRATULaunchPage();
		System.out.println("You Are Renting 'Across the Universe' Movie...");
      ...
      System.out.println("   ");
                        ...
                        System.out.println("|------------------------------------------------|");
                        System.out.println("|    Rented Movie: Across the Universe           |");
                        System.out.println("|    Amount Paid: $57.00                         |");
                        System.out.println("|------------------------------------------------|");
                        System.out.println("|    Release Year: 2007                          |");
                        System.out.println("|------------------------------------------------|");
                        System.out.println("|    Movie Lenght: 2:11                          |");
                        System.out.println("|    Movie Rating: 53%                           |"); 
                        System.out.println("|________________________________________________|");
                        
      System.out.println("   ");
      System.out.println("You have Successfully rented 'Across the Universe' Movie.");
      System.out.println("   ");

...
/** CIDLaunchPage is a new class that displayes a new window for a specific movie. 
  * @authors Dursen Tulema, Hegni Yonis, Nolan Thomson*/


public class CIDLaunchPage extends Frame implements ActionListener
{
  /** Construct a new CIDLaunchPage. */
  ...
  public void paint(Graphics g)
        { 
         ...
         Image img1 = tk.getImage("CIDwindow.png");
   ...
   public void actionPerformed(ActionEvent ae)
	  {
		...
		{
		System.out.println("You Are Renting 'Idiocracy' Movie...");
      ...
      System.out.println("   ");
                        ...
                        System.out.println("|------------------------------------------------|");
                        System.out.println("|    Rented Movie: Idiocracy                     |");
                        System.out.println("|    Amount Paid: $14.99                         |");
                        System.out.println("|------------------------------------------------|");
                        System.out.println("|    Release Year: 2006                          |");
                        System.out.println("|------------------------------------------------|");
                        System.out.println("|    Movie Lenght: 1:24                          |");
                        System.out.println("|    Movie Rating: 73%                           |"); 
                        System.out.println("|________________________________________________|");
                        
      System.out.println("   ");
      System.out.println("You have Successfully rented 'Idiocracy' Movie.");
      System.out.println("   ");

...
/** ABPLaunchPage is a new class that displayes a new window for a specific movie. 
* @authors Dursen Tulema, Hegni Yonis, Nolan Thomson*/

public class ABPLaunchPage extends Frame implements ActionListener
{

     /** Construct a new ABPLaunchPage. */
   ...
   public void paint(Graphics g)
        { 
         ...
         Image img1 = tk.getImage("ABPwindow.png");
   ...
   public void actionPerformed(ActionEvent ae)
	  {
		...
		{
      rABPLaunchPage reciept = new rABPLaunchPage();
		System.out.println("You Are Renting 'Black Panther' Movie...");
      System.out.println("   ");
      ...
      System.out.println("   ");
                        ...
                        System.out.println("|------------------------------------------------|");
                        System.out.println("|    Rented Movie: Black Panther                 |");
                        System.out.println("|    Amount Paid: $16.67                         |");
                        System.out.println("|------------------------------------------------|");
                        System.out.println("|    Release Year: 2018                          |");
                        System.out.println("|------------------------------------------------|");
                        System.out.println("|    Movie Lenght: 2:15                          |");
                        System.out.println("|    Movie Rating: 96%                           |"); 
                        System.out.println("|________________________________________________|");
                        
      System.out.println("   ");
      System.out.println("You have Successfully rented 'Black Panther' Movie.");
      System.out.println("   ");

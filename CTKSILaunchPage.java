...
/** CTKSILaunchPage is a new class that displayes a new window for a specific movie. 
  * @authors Dursen Tulema, Hegni Yonis, Nolan Thomson*/


public class CTKSILaunchPage extends Frame implements ActionListener
{
   /** Construct a new CTKSILaunchPage. */
      ...
      Button btnRent;
      public CTKSILaunchPage()
      
      {
         
         super("The King od Staten Island"); 
         resize(1200,675);
         show();
			makeMenus();
  ...
  public void paint(Graphics g)
        { 
         ...
         Image img1 = tk.getImage("CTKSIwindow.png");
   ...
   public void actionPerformed(ActionEvent ae)
	  {
		...
		{
		System.out.println("You Are Renting 'The King of Staten Island' Movie...");
      ...
      System.out.println("   ");
                        ...
                        System.out.println("|------------------------------------------------|");
                        System.out.println("|    Rented Movie: The King of Staten Island     |");
                        System.out.println("|    Amount Paid: $14.99                         |");
                        System.out.println("|------------------------------------------------|");
                        System.out.println("|    Release Year: 2004                          |");
                        System.out.println("|------------------------------------------------|");
                        System.out.println("|    Movie Lenght: 2:04                          |");
                        System.out.println("|    Movie Rating: 53%                           |"); 
                        System.out.println("|________________________________________________|");
                        
      System.out.println("   ");
      System.out.println("You have Successfully rented 'The King of staten Island' Movie.");
      System.out.println("   ");

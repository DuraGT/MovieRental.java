...
/** CMBLaunchPage is a new class that displayes a new window for a specific movie. 
  * @authors Dursen Tulema, Hegni Yonis, Nolan Thomson*/


public class CMBLaunchPage extends Frame implements ActionListener
{

 /** Construct a new CMBLaunchPage. */
      ...
      public void paint(Graphics g)
         ...
         Image img1 = tk.getImage("CMBwindow.png");
         g.drawImage(img1, 0, 50, 1150, 625, this);
   ...
   public void actionPerformed(ActionEvent ae)
	  {
		...
		{
		System.out.println("You Are Renting 'Mr Bean' Movie...");
      ...
      System.out.println("   ");
                        ...
                        System.out.println("|------------------------------------------------|");
                        System.out.println("|    Rented Movie: Bean                          |");
                        System.out.println("|    Amount Paid: $14.99                         |");
                        System.out.println("|------------------------------------------------|");
                        System.out.println("|    Release Year: 1997                          |");
                        System.out.println("|------------------------------------------------|");
                        System.out.println("|    Movie Lenght: 1:25                          |");
                        System.out.println("|    Movie Rating: 44%                           |"); 
                        System.out.println("|________________________________________________|");
                        
      System.out.println("   ");
      System.out.println("You have Successfully rented 'Mr Bean' Movie.");
      System.out.println("   ");
